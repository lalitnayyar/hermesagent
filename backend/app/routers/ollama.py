...
def ollama(payload: dict) -> dict:
    ...
    host = host.replace("127.0.0.1:11434", "host.docker.internal:11434").replace("localhost:11434", "host.docker.internal:11434")
    if not prompt:
    ...
    try:
        ...
        detail = f"Ollama request failed: {e}. If Ollama is running on the host, start it with OLLAMA_HOST=0.0.0.0:11434 so Docker can reach it."
